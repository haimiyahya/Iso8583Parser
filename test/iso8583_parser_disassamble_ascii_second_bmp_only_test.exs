defmodule Iso8583ParserDisassableAsciiSecondBmpOnlyTest do
  use ExUnit.Case
  ...
  test "ascii msg field (2)numeric(25), (2)numeric(7), ascii(20)" do
    ...
    f65_len = f65_val |> String.length |> Integer.to_string() |> String.pad_leading(2, "0")
    f65 = f65_len <> f65_val
  ...
  test "ascii msg field (3)numeric(5), numeric(7), (2)ascii(8)" do
    ...
    f65_val = "12345"
    f65_len = f65_val |> String.length |> Integer.to_string() |> String.pad_leading(3, "0")
    f65 = f65_len <> f65_val
  ...
  test "ascii msg field (2)binary(50), (1)ascii(5), ascii(7)" do
    ...
    f65_len = f65_len * 8
    f65_len = f65_len |> Integer.to_string() |> String.pad_leading(2, "0")
    f65 = f65_len <> Base.encode16(f65_val)
