defmodule Iso8583ParserDisassableAsciiFirstAndSecondBmpTest do
  use ExUnit.Case
  ...
  test "ascii msg field bin, numeric(h), track 2(h)" do
    ...
    f30 = f30_val |> Base.encode16()

    f66_val = "23"
    f66_len = f66_val |> String.length() |> Integer.to_string() |> String.pad_leading(2, "0")
    f66 = f66_len <> f66_val

    f67_val = "1234567890ABCDEF1234567890ABCDEF12345"
    f67_len = f67_val |> String.length() |> Integer.to_string() |> String.pad_leading(2, "0")
    f67 = f67_len <> f67_val
  ...
  test "ascii msg field (2)numeric(25), (2)numeric(7), ascii(20)" do
    ...
    f65_len = f30_val |> String.length |> Integer.to_string() |> String.pad_leading(2, "0")
    f30 = f65_len <> f30_val
  ...
  test "ascii msg field (3)numeric(5), numeric(7), (2)ascii(8)" do
    ...
    f30_val = "12345"
    f65_len = f30_val |> String.length |> Integer.to_string() |> String.pad_leading(3, "0")
    f30 = f65_len <> f30_val
  ...
  test "ascii msg field ascii(15), ascii(12), (3)binary(999)" do
    ...
    f67_len = f67_len * 8 |> Integer.to_string() |> String.pad_leading(3, "0")
    f67 = f67_len <> Base.encode16(f67_val)
  ...
  test "ascii msg field (2)track2(39), num(12), (3)ascii(999)" do
    ...
    f65_len = f65_len |> Integer.to_string() |> String.pad_leading(2, "0")
    f30 = f65_len <> f30_val
    ...
    f67_len = f67_val |> String.length()
    f67_len = f67_len |> Integer.to_string() |> String.pad_leading(3, "0")
    f67 = f67_len <> f67_val
  ...
  test "ascii msg field (2)track2(10), (2)num(50), (2)ascii(999)" do
    ...
    f66_len = f66_len |> Integer.to_string() |> String.pad_leading(2, "0")
    f66 = f66_len <> f66_val

    f67_val = "8765432101234567890123456"
    f67_len = f67_val |> String.length()
    f67_len = f67_len |> Integer.to_string() |> String.pad_leading(2, "0")
    f67 = f67_len <> f67_val
  ...
  test "ascii msg field (2)binary(50), (1)ascii(5), ascii(7)" do
    ...
    f65_len = f65_len * 8
    f65_len = f65_len |> Integer.to_string() |> String.pad_leading(2, "0")
    f30 = f65_len <> Base.encode16(f30_val)

    f66_val = "87654"
    f66_len = f66_val |> String.length()
    f66_len = f66_len |> Integer.to_string()
    f66 = f66_len <> f66_val
  ...
  test "ascii msg field (1)binary(10), ascii(7), binary(64)" do
    ...
    f65_len = f30_val |> byte_size()
    f65_len = f65_len * 8
    f65_len = f65_len |> Integer.to_string()
    f30 = f65_len <> Base.encode16(f30_val)
